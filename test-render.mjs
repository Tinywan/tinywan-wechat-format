...
const checks = [
  ...
  ['圆点深色 6px', html.includes('<span style="color:#333;font-weight:bold;font-size:6px;">●</span>')],
  ['有序数字主色', html.includes('<span style="color:#2273b8;font-weight:bold;">1.</span>')],
  ['列表行高 1.8', html.includes('font-size:15px;line-height:1.8;letter-spacing:0.3px')],
  ['全文无 border-radius:50%', !html.includes('border-radius:50%')],
  ['列表悬挂缩进', html.includes('padding-left:26px;text-indent:-26px')],
